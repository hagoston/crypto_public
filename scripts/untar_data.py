...
def fanout_unziptar(in_path, out_path, ffilter = ''):
    ...
    for ipath in in_paths:
        ...
        for root, _, files in os.walk(ipath):
            for i in files:
                if i.endswith("tar.gz") and i.find(filter) != -1:
...
if __name__=="__main__":
    ...
    # python3 untar_data.py --input_path ~/temp/crypto/data/binance_targz --output_path ~/temp/crypto/data/binance_uncompressed --filter BTCUSDT_T_DEPTH_20210401-20210402
    import argparse
